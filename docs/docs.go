...
// @description This service provides a standards-compliant EST implementation that uses OpenBao as the backend PKI system.
// @description
    ...
    "definitions": {
        "pkg_server.BackendHealthDetail": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "\"openbao\" or \"openbao\"",
                    "type": "string"
                },
                "version": {
