...
func ParseBackendError(err error) *BackendError {
	...
	if strings.Contains(errLower, "permission denied") ||
		...
		return &BackendError{
			...
			Details:    extractBackendError(errStr),
		}
	}
...
// extractBackendError extracts the meaningful error message from OpenBao API errors
func extractBackendError(errStr string) string {
	// Look for "Errors:\n\n* <message>"
