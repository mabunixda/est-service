...
LDFLAGS=-ldflags "-w -s -X github.com/mabunixda/est-service/internal/version.Version=${VERSION} \
	-X github.com/mabunixda/est-service/internal/version.GitCommit=${GIT_COMMIT} \
	-X github.com/mabunixda/est-service/internal/version.BuildDate=${BUILD_DATE}"
...
# Integration tests (requires running OpenBao instance)
# Tests will skip gracefully if environment variables are not set
test-integration:
